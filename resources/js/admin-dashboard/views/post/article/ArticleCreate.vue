...
<template>
    <BasePageContainer variant="wide">
        <BasePageHeader title="Create New Article" subtitle="Draft your content and manage SEO in one place" back-label="Back to Articles" back-route-name="articles.index" />
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm font-bold text-slate-700 mt-1">Draft / Unpublished</p>
                            </div>
                        </div>

                        <div class="grid grid-cols-1 gap-3">
                            <BaseButton icon="rocket_launch" class="w-full justify-center py-4" @click="submit('Published')" :loading="isLoading">
                                Publish Article
                            </BaseButton>
                            <BaseButton variant="ghost" class="w-full justify-center py-4" @click="submit('Draft')" :loading="isLoading">
                                Save as Draft
                            </BaseButton>
