...
<template>
    <BasePageContainer variant="narrow">
        <BasePageHeader title="Edit Role" subtitle="Modify permissions and access for this role"
                ...
                <template #footer>
                    <div
                        ...
                        <div class="flex gap-3 w-full sm:w-auto order-1 sm:order-2">
                            ...
                            <BaseButton icon="save" class="flex-1 sm:flex-none" @click="submit" :loading="isLoading">
                                Save Changes
                            </BaseButton>
                        </div>
                    </div>
